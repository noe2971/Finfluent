...
Instructions:
Please provide a comprehensive and detailed financial health analysis for the user above. Format your response in plain text using bullet points with exactly three bullet points for each of the following categories. Do not include any other bullet points or numbers outside these categories.
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <section className="bg-white rounded-xl shadow-lg p-6 mb-12">
          <div className="flex items-center justify-between mb-4">
            ...
            >
              {loadingRec ? "Loading..." : "Refresh AI Recommendations"}
            </button>
          </div>
          {errorMessage ? (
        ...
        <footer className="text-center text-sm text-gray-600">
          ...
          <p>
            All recommendations provided on this page are generated by AI based on your data.
