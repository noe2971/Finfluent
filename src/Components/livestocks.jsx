...
const Stocks = () => {
    ...
    const defaultStocks = [
        ...
        'UNH', 'HD', 'PG', 'XOM', 'KO', 'PEP', 'NFLX', 'ADBE', 'CSCO', 'PFE', 'T', 'NKE', 
        'INTC', 'MRK', 'DIS', 'AMD', 'WMT', 'BAC', 'CRM', 'ABT', 'CVX', 'LLY', 'QCOM', 'MCD', 
        'ORCL', 'BABA', 'DHR', 'UPS', 'COST', 'PM', 'TMO', 'TXN', 'SCHW', 'HON', 'AMGN', 'LIN', 
        'MDT', 'PYPL', 'IBM', 'AVGO', 'SBUX', 'NOW', 'SPGI', 'DE', 'SPY', 'VOO', 'QQQ', 'VTI', 
        'IVV', 'DIA', 'IWM', 'VEA', 'VNQ'
    ];
